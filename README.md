...
Everything else, and GNOME's `wayland-vnc-grd`, installs from the release assets:
...
`SHA256SUMS` manifest, plus `wayland-vnc-grd` for GNOME. The Flatpak is the settings
